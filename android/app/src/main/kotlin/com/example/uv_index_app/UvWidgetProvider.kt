...
class UvWidgetProvider : HomeWidgetProvider() {
    override fun onUpdate(
        ...
        for (widgetId in appWidgetIds) {
            val views = RemoteViews(context.packageName, R.layout.uv_widget_layout)

            val value = widgetData.getInt("uv_value", -1)
            val label = widgetData.getString("uv_label", "") ?: ""
            ...
            val updatedAt = widgetData.getString("uv_updated_at", "") ?: ""
